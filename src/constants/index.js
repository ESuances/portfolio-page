...
export const clientReviews = [
    {
        id: 1,
        name: 'Antonio Bojorquez',
        position: 'Jefe de departamento de concursos y contratos',
        img: 'assets/review2.png',
        review:
            'Trabajar con Erick fue todo un placer, es un joven increible con muchas ganas de seguir creciendo, aprende rapido y no decepciona en sus tiempos de entrega.',
    },
    {
        id: 2,
        name: 'Mark Rogers',
...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        JavaLogoPosition: isSmall ? [-5, -10, -10] : isMobile ? [-9, -10, -10] : isTablet ? [-11, -7, -10] : [-13, -13, -10],
    };
};
